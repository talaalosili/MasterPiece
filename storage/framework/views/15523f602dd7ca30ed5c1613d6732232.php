...
<?php $__env->startSection('content'); ?>
    ...
    <div class="card mt-4">
        ...
        <div class="card-body">
            ...
            <p class="card-text">
                <?php if($user->image): ?>
                    <img src="<?php echo e(asset($user->image)); ?>" alt="User Image" style="width: 150px; height: 150px;">
                <?php endif; ?>
            </p>
...
<?php echo $__env->make('dashboard.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\user\Desktop\MP\sterPiece\resources\views/dashboard/users/show.blade.php ENDPATH**/ ?>